...
// VpnConfig represents the configuration for VPN functionality
...
// SetVpnRules updates the routing rules for the VPN
// TEMPORARILY REMOVED DUE TO GOMOBILE BINDING ISSUES
// func (a *AppLib) SetVpnRules(rules []map[string]interface{}) error {
// 	// Store rules for future matching
