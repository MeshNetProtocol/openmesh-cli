...
struct AppConstants: Sendable {
    nonisolated static let appGroupMain = "group.com.meshnetprotocol.OpenMesh"
    nonisolated static let appGroupMacSys = "group.com.meshnetprotocol.OpenMesh.macsys"
}
...
private func writeConfigModePatchStateFile(_ config: [String: Any], isGlobalMode: Bool) {
    ...
    let appGroupID = (Bundle.main.bundleIdentifier?.hasSuffix(".macsys") == true)
