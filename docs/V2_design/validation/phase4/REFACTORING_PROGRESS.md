...
**状态**: ⏸️ 未开始  
**预计开始**: 2026-04-21 ~ 2026-04-25  
**预计完成**: 2026-04-24 ~ 2026-04-30

### 3.1 套餐选择界面

| 任务 | 状态 | 文件 | 说明 |
|------|------|------|------|
| 设计套餐卡片 UI | ⏸️ 未开始 | index.html | Free/Basic/Premium |
| 实现套餐选择逻辑 | ⏸️ 未开始 | app.js | 选择套餐 |
| 添加年付/月付切换 | ⏸️ 未开始 | app.js | 按钮切换 |
| 显示套餐对比 | ⏸️ 未开始 | index.html | 功能对比表 |

### 3.2 流量使用显示

| 任务 | 状态 | 文件 | 说明 |
|------|------|------|------|
| 实现流量进度条 | ⏸️ 未开始 | index.html | 日/月流量 |
| 实现流量查询 | ⏸️ 未开始 | app.js | API 调用 |
| 添加流量重置倒计时 | ⏸️ 未开始 | app.js | 显示重置时间 |
| 添加超限提醒 | ⏸️ 未开始 | app.js | 红色警告 |

### 3.3 订阅变更界面

| 任务 | 状态 | 文件 | 说明 |
|------|------|------|------|
| 实现升级界面 | ⏸️ 未开始 | index.html | 显示补差价 |
| 实现降级界面 | ⏸️ 未开始 | index.html | 显示生效时间 |
| 实现变更确认弹窗 | ⏸️ 未开始 | app.js | 二次确认 |
| 显示待生效变更 | ⏸️ 未开始 | index.html | nextPlanId 提示 |
| 实现取消变更 | ⏸️ 未开始 | app.js | 取消按钮 |

### 3.4 签名流程

| 任务 | 状态 | 文件 | 说明 |
|------|------|------|------|
| 实现 UpgradeIntent 签名 | ⏸️ 未开始 | app.js | EIP-712 |
| 实现 DowngradeIntent 签名 | ⏸️ 未开始 | app.js | EIP-712 |
| 实现 CancelChangeIntent 签名 | ⏸️ 未开始 | app.js | EIP-712 |
| 添加签名进度提示 | ⏸️ 未开始 | app.js | 步骤显示 |

### 3.5 UI/UX 优化

| 任务 | 状态 | 文件 | 说明 |
|------|------|------|------|
| 响应式设计 | ⏸️ 未开始 | style.css | 移动端适配 |
| 加载动画 | ⏸️ 未开始 | style.css | Spinner |
| 错误提示优化 | ⏸️ 未开始 | app.js | 友好的错误信息 |
| 成功提示优化 | ⏸️ 未开始 | app.js | Toast 通知 |
